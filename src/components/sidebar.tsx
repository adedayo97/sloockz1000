...
const Sidebar: FC<SidebarProps> = ({userWorkspaceData, currentWorkspaceData, userData}) => {
    ...
    return (
        <aside
            ...
            `} 
        >
            <SidebarNav  currentWorkspaceData={currentWorkspaceData} userWorkspaceData={userWorkspaceData}/>
                                            ...
                                            <div className="h-full w-full rounded-lg overflow-hidden">
                                                ...
                                                >
                                                    {userData.is_away ? (
                                                        ...
                                                        <GoDotFill className="text-blue-600" size={17} />
                                                    )}
